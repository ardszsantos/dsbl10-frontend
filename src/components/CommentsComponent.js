...
const CommentsComponent = ({ postId }) => {
  ...
  return (
    <div className="w-full bg-gray-300 dark:bg-primary rounded-md p-5 lg:w-10/12 mx-auto mt-8">
      <h2 className="text-2xl font-semibold  text-center mb-4 text-gray-900 dark:text-gray-100">Comments</h2>
      ...
      {userId ? (
        <form onSubmit={handleCommentSubmit} className="mb-6 flex flex-row items-center w-full">
          <input
            type="text"
          ...
          <button
            type="submit"
            className="w-full md:w-auto bg-blue-500 dark:bg-blue-700 ml-2 text-white p-3 rounded-b-lg md:rounded-r-lg md:rounded-bl-none hover:bg-blue-600 dark:hover:bg-blue-800 flex items-center justify-center transition-all duration-200"
